  ...
  return (
     ...
     <div className='bannerBoxV2 w-full overflow-hidden rounded-md group relative'>
      <img src={props.image}
       ...
       <div className={`info absolute p-5 top-0 ${props.info==="left" ? 'left-0': 'right-0'} w-[40%] h-[100%] z-50
       flex items-center justify-center flex-col gap-2 ${props.info==="left" ? '': 'pl-12'}`}>
        ...
        <span className='text-[20px] text-primary text-[600] w-full'>₹1500</span>
        <div className='w-full'>
          <Link className='text-[16px] font-[600] link' to="/" >SHOP NOW</Link>
        </div>
